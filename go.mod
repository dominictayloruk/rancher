...
replace (
	...
	github.com/hashicorp/go-retryablehttp => github.com/hashicorp/go-retryablehttp v0.7.7 // CVE-2024-6104
...
require (
	...
	github.com/rancher/apiserver v0.2.0
	...
	github.com/rancher/steve v0.2.1
